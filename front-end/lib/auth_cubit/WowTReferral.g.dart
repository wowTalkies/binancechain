...
class WowTReferral extends _i1.GeneratedContract {
  WowTReferral({
  ...
  /// set by the contract.
  Future<String> addReferralPoints(
    _i1.EthereumAddress _installAddress,
    _i1.EthereumAddress _referralAddress, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[0];
    assert(checkSignature(function, '0af69880'));
    final params = [
      _installAddress,
      _referralAddress,
    ];
