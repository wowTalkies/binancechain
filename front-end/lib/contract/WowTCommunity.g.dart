...
class WowTCommunity extends _i1.GeneratedContract {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<GetCommunityDetails> getCommunityDetails(
    String _communityName, {
    _i1.BlockNum? atBlock,
  }) async {
    final function = self.abi.functions[11];
    assert(checkSignature(function, '1cf5a07b'));
    final params = [_communityName];
    final response = await read(
      function,
      params,
    ...
    return GetCommunityDetails(response);
  }
...
class GetCommunityDetails {
  GetCommunityDetails(List<dynamic> response)
      : var1 = (response[0] as String),
        var2 = (response[1] as String),
        var3 = (response[2] as List<dynamic>).cast<String>(),
